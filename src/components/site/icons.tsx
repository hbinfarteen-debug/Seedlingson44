...
/** Official WhatsApp glyph (brand mark) as an inline SVG. */
...
/** A simple sprouting leaf mark for the brand logo. */
export function SproutIcon({
  ...
  return (
    ...
    >
      ...
      <path d="M12 11C12 7 9 4 4 4c0 5 3 8 8 8" />
      <path d="M12 11c0-4 3-7 8-7 0 5-3 7-8 7" />
    </svg>
  );
}
